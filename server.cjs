...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Child Protective Services Case Management Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "CPS Case Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "cps_case_record_records";
'use strict';
